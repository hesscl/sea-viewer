...
sea_shp <- spTransform(sea_shp, CRS("+proj=longlat +datum=WGS84"))
kc_shp <- spTransform(kc_shp, CRS("+proj=longlat +datum=WGS84"))
...
### Daily 1-bedroom median rent time-series (30-day rolling average)
